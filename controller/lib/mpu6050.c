...
uint8_t mpu6050_init(void) {
    ...
    /* Set the scale range of the gyroscope to ± 500 °/s */
    mpu6050_set(MPU6050_GYRO_CONFIG, 0x0B);

    /* Set the scale range of the acclerometer to ± 4g and the high pass filter to 5Hz */
    mpu6050_set(MPU6050_ACCEL_CONFIG, 0x09);
